...
class CreateBidUseCase implements UseCase<CreateBidResponseModel, CreateBidEntity> {
  final BidRepository bidRepository;
  CreateBidUseCase(this.bidRepository);
  @override
  Future<Either<Failure, CreateBidResponseModel>> call(CreateBidEntity createBidEntity) async{
